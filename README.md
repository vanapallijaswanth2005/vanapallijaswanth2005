...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:61DAFB,100:0077B5&height=220&section=header&text=Hi%20there,%20I'm%20Jaswanth%20👋&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Aspiring%20Backend%20Developer%20|%20Java%20&%20SpringBoot%20Enthusiast&descAlignY=55&descSize=18" width="100%"/>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=61DAFB&center=true&vCenter=true&width=600&lines=Aspiring+Backend+Developer+%F0%9F%9A%80;Learning+SpringBoot+%26+REST+APIs;1000%2B+Problems+Solved+Across+Platforms;Java+Full+Stack+Certified+%E2%9C%85" alt="Typing SVG" />
...
public class Jaswanth implements SoftwareDeveloper {
    ...
    String[] technologies  = {"SpringBoot", "REST APIs", "JDBC"};
    String database        = "MySQL";
    String[] tools         = {"Git", "GitHub", "Postman"};
    
    @Override
    public void executeCurrentFocus() {
        System.out.println("Deep diving into SpringBoot & following Striver / RaisingBrain SDE sheets.");
    }
}
```

- 🏆 **1000+** coding problems solved across platforms, including **200+** on LeetCode.
